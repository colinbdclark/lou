...
(function () {
    ...
    fluid.defaults("colin.lou.synths.drumBass", {
        ...
        synthDef: [
            // Drum
            {
                ...
                buffer: {
                    id: "tom",
                    url: "../lou/audio/44100/tom-44100.wav"
                }
            },
    ...
    fluid.defaults("colin.lou.synths.pianoGuitar", {
        ...
        synthDef: [
            // Piano
            {
                ...
                buffer: {
                    id: "dsharp-piano",
                    url: "../lou/audio/44100/piano-combined-44100.wav"
                }
            },
            ...
            // Guitar
            {
                ...
                buffer: {
                    id: "csharp-guitar",
                    url: "../lou/audio/44100/guitar-combined-44100.wav"
                }
            }
        ]
    });
    ...
    flock.ugenDefaults("colin.lou.ugen.lag", {
        rate: "audio",
        inputs: {
            source: undefined,
            time: 0.1
